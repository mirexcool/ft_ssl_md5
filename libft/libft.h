...
/*   Updated: 2017/05/11 19:13:00 by yyefimov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				**ft_strsplit_white(const char *str);
...
void				*ft_memchr(const void *data, int c, size_t n);
...
char				*ft_itoa_unsigned(unsigned long long v, int base, char mod);
